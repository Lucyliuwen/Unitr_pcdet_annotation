...
class DynamicPillarVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        logging.info(f"points:  x, y, z, i, e---------{points[:1, :]}")
        ...
        logging.info(f"features Shape:\t{features.shape};\tf_center Shape: {f_center.shape};\tf_cluster Shape: {f_cluster.shape};\tpoint Shape: {points[:, 1:].shape}")
        logging.info(f"features: ---{features[:1, :]}")
